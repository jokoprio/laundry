            ...
            <div class="bg-gradient-to-r from-indigo-600 to-indigo-700 px-8 py-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-indigo-100 text-sm mt-1">Perbarui password akun Anda</p>
                    </div>
                </div>
            </div>

            <!-- Form -->
            <form action="{{ route('owner.profile.update-password') }}" method="POST" class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="current_password" id="current_password"
                            class="w-full pl-12 pr-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all @error('current_password') border-red-300 @enderror"
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="new_password" id="new_password"
                            class="w-full pl-12 pr-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all @error('new_password') border-red-300 @enderror"
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="new_password_confirmation" id="new_password_confirmation"
                            class="w-full pl-12 pr-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
